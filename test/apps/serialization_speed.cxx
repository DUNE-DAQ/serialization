...
void sender_thread_fn(dunedaq::serialization::networkobjectsender::Conf sender_conf, int n_messages)
{
...
void receiver_thread_fn(dunedaq::serialization::networkobjectreceiver::Conf receiver_conf, int n_messages)
{
  int total=0;
