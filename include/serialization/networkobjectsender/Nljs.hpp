 ...
 * namespace dunedaq::serialization::networkobjectsender to be serialized via nlohmann::json.
 */
#ifndef DUNEDAQ_SERIALIZATION_NETWORKOBJECTSENDER_NLJS_HPP
#define DUNEDAQ_SERIALIZATION_NETWORKOBJECTSENDER_NLJS_HPP
...
#endif // DUNEDAQ_SERIALIZATION_NETWORKOBJECTSENDER_NLJS_HPP